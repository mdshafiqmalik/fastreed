...
if (isset($_SESSION['logID'])) {
  if (isset($_SESSION['loggedIn'])){
    if ((boolean)$_SESSION['loggedIn']) {
      ...
      $GLOBALS['Menu'] = $loggedProfile."<div id='user'>".$writeArticles.$updateProfile.$channels.'</div> <div style="background-color:cadetblue;" id="user">'.$Interests.$Languages.$privacy.$securityLogin.'</div><div style="background-color:teal;"id="user">'.$termsPolicy.$helpFeedback.$aboutUs.$logout."</div>";
    }else {
